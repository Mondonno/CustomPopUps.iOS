...
namespace CPopupLibrary
{
    public class CustomPopUpViewController : UIView
    {
        ...
        //PopUp Showing
        public void PopUp( bool animated = true, Action popAnimationFinish = null, double? Aduration = null)
        {
        ...
        //Closing PopUp
        public void Close(bool animated = true, double? Aduration = null)
        {
            if (Aduration == null)
            {
                Aduration = 0.15;
        ...
        //Animations
        private void Slide(double Aduration)
        {

        }
        private void Bounce(double Aduration)
        {

            UIView.Animate(Aduration, delegate
            {
                Transform = CGAffineTransform.MakeScale(0.1f, 0.1f);
                Transform = CGAffineTransform.MakeScale(0.08f, 0.08f);
                Transform = CGAffineTransform.MakeScale(0.1f, 0.1f);
                effectView.Alpha = 0;
